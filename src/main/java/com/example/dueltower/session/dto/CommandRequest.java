 ...
 * START_COMBAT, DRAW, END_TURN, HAND_SWAP, PLAY_CARD, USE_EX, USE_SUMMON_ACTION, USE_EQUIP_ACTION, RELOAD_EQUIPMENT, USE_ITEM, BUY_SHOP_ITEM, LEAVE_SHOP, OPEN_CHEST, RESOLVE_JUDGEMENT, SURRENDER_COMBAT, SELL_INVENTORY_ITEM, RETREAT_COMBAT, DISCARD_TO_HAND_LIMIT, RESOLVE_INITIATIVE_TIE, SEARCH_PICK/RESOLVE_SEARCH_PICK, LAST_WORDS, RESOLVE_REACTION, SELECT_NODE_CHOICE, CLEAR_RECENT_RESULTS, ENEMY_PLAY_CARD, ENEMY_USE_EX, ENEMY_END_TURN.
 * <p>
 ...
 * DRAW, PLAY_CARD, HAND_SWAP, END_TURN, USE_EX, USE_SUMMON_ACTION, USE_EQUIP_ACTION, RELOAD_EQUIPMENT, USE_ITEM, BUY_SHOP_ITEM, LEAVE_SHOP, OPEN_CHEST, RESOLVE_JUDGEMENT, SURRENDER_COMBAT, SELL_INVENTORY_ITEM, RETREAT_COMBAT, DISCARD_TO_HAND_LIMIT, RESOLVE_INITIATIVE_TIE, SEARCH_PICK/RESOLVE_SEARCH_PICK, LAST_WORDS, RESOLVE_REACTION, SELECT_NODE_CHOICE, CLEAR_RECENT_RESULTS.
 *
 ...
 * - SELL_INVENTORY_ITEM 후보 필드: itemId or inventoryEquipId / count
...
public record CommandRequest(
    ...
    public String trimmedInventoryEquipId() {
        return trimToNull(inventoryEquipId);
    }
